...
@Component({
  templateUrl: './solved-problem-list.component.html',
  styleUrls: ['./solved-problem-list.component.css'],
})
export class SolvedProblemListComponent implements OnInit, OnDestroy {
  searchText = "";
  problems: Problem[] = [];
  isLoading = false;
  userId: string;
